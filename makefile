...
$(BINDIR)/TestDFASeeder: $(SRCDIR)/TestDFASeeder.cpp $(ODIR)/CommonUtils.o $(ODIR)/BigraphToDigraph.o $(ODIR)/AlignmentGraph.o $(ODIR)/vg.pb.o $(ODIR)/GfaGraph.o $(ODIR)/fastqloader.o $(ODIR)/ThreadReadAssertion.o
	$(GPP) -o $@ $^ $(LINKFLAGS)
